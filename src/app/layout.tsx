...
export const metadata: Metadata = {
  title: "Caramella's Cake Shop | Premium Handcrafted Cakes in Moshi & Pune",
  description: "Premium cakes and desserts in Moshi & Pune. Custom cake designs, fresh ingredients, same-day orders. Order your dream cake from Caramella's today.",
  keywords: "cake shop Moshi, bakery Pune, custom cakes, birthday cakes, wedding cakes, premium desserts",
  metadataBase: new URL("https://caramellas.com"),
  alternates: {
    canonical: "https://caramellas.com",
  },
  openGraph: {
    title: "Caramella's Cake Shop | Premium Handcrafted Cakes",
    description: "Fresh, premium cakes and desserts for every celebration. Custom designs available.",
    url: "https://caramellas.com",
    siteName: "Caramella's Cake Shop",
    type: "website",
    images: [
      {
        url: "http://img.b2bpic.net/free-photo/side-close-up-view-cake-cake-with-berries-powdered-sugar-waffles-green-sauce_140725-71803.jpg",
        alt: "Caramella's Premium Cake Display",
      },
    ],
  },
  twitter: {
    ...
    title: "Caramella's Cake Shop | Premium Handcrafted Cakes",
    description: "Fresh, premium cakes and desserts for every celebration. Order now.",
    images: ["http://img.b2bpic.net/free-photo/side-close-up-view-cake-cake-with-berries-powdered-sugar-waffles-green-sauce_140725-71803.jpg"],
  },
  robots: {
    index: true,
    follow: true,
